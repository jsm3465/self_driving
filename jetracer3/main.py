...
campub = ImageMqttPusblisher("192.168.3.250", pubTopic="/rover3/camerapub")
campub.connect()

campub2 = ImageMqttPusblisher("192.168.3.250", pubTopic="/blackBox/rover3")
campub2.connect()
                ...
                # ----------- navi ------------
                    ...
                    if start is not None and end is not None:
                        if len(clss) > 0:
                            ...
                            objectpub.client.publish("/rover3/navi", "driving")
