		...
		<div class="fluid-container vw-100 vh-100">
			<header id="headerDiv" class="row">
				...
				<div id="titleDiv" class="col-6">
					<h2 id="title" >Control Center</h2>
				</div>
				<div id="userIdDiv" class="col-3">
					<h6 id="userId">${sessionMid}</h6>
				</div>
			</header>
			<section class="row">
				<div id="roverList" class="col-4">
					<h4 id="selectCar">Select Car</h4>
					...
					<button id="resisterRoverFormButton" type="submit"
						class="btn btn-outline-warning btn-block" form="resisterRoverForm">+</button>
				</div>
				<div id="mapDiv" class="col-8">
					<h4 id="map">Map</h4>
					<div class="h-8">
